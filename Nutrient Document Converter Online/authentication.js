...
const getAccessToken = async (z, bundle) => {
  const response = await z.request({
    url: 'https://api.muhimbi.com/auth/pages/gettoken.aspx?grant_type=authorization_code',
    method: 'POST',
    body: {
      client_id: 'PPF29A64-8D58-4092-A64A-04A0E7CEAE7B',
      client_secret: 'ppcdefghilmnbpqrstuvzabrstuvzabchgldpnkmngrreweds=',
...
const refreshAccessToken = async (z, bundle) => {
  const response = await z.request({
    url: 'https://api.muhimbi.com/auth/pages/gettoken.aspx?grant_type=refresh_token',
    method: 'POST',
    body: {
      client_id: 'PPF29A64-8D58-4092-A64A-04A0E7CEAE7B',
      client_secret: 'ppcdefghilmnbpqrstuvzabrstuvzabchgldpnkmngrreweds=',
...
const test = (z, bundle) => {
  return 'Connection successful!'; // Simple string for test
};
...
module.exports = {
  config: {
    ...
    oauth2Config: {
      authorizeUrl: {
        url:'https://api.muhimbi.com/auth/pages/authorize.aspx',
